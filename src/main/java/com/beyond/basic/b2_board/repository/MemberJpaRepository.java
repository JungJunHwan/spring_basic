...
//    Entity의 생명주기를 관리, db와의 모든 인테피이싱을 책임, 엔티티를 대상으로 CRUD 기능을 제공
    private final EntityManager entityManager;
    public MemberJpaRepository(EntityManager entityManager){
        this.entityManager = entityManager;
    }

//    순수 JPA는 기본적인 CRUD만 제공해주고, 상당수의 쿼리는 직접 작성해야함
...
//        여기서 작성되는 쿼리는 문자열 형식의 쿠리가 아니라 jpql(객체 지향 쿼리문)이다
        Member member = null;
        try {
...
//        persist : 전달된 엔티티가 EntityManager의 관리상태가 되도록 만들어주고, 트랜잭션이 커밋될때 db에 저장됨
